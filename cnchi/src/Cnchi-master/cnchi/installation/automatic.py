...
class InstallationAutomatic(GtkBaseBox):
    ...
    def translate_ui(self):
        ...
        txt = _("Select the drive we should use to install Apricity OS and then click above to start the process. Note: If you are booting this live image under UEFI, we recommend that you select gummiboot for your bootloader.")
        label.set_markup(txt)
