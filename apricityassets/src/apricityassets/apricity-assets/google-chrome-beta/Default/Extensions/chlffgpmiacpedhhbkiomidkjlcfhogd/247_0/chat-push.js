    ...
    var pushesFilter = function(push) {
        if (stream.with) {
            ...
            if (stream.iden == '*') {
                ...
                return (push.direction == 'self' && !push.client_iden && (push.source_device_iden == stream.iden || push.stream_device_iden == stream.iden))
    ...
    chunks.forEach(function(chunk) {
        ...
        chunk.forEach(function(push) {
            ...
            if (push == lastPush) {
                ...
                thumbnail.src = utils.streamImageUrl(findStream(push));
